...
{
    public class when_reporting_a_success_event_with_category_and_no_category_explicitly_specified : Specification
    {
        ...
        public when_reporting_a_success_event_with_category_and_no_category_explicitly_specified()
        {
