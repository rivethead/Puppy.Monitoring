...
{
    public class when_reporting_a_failure_event_with_category_and_sub_category : Specification
    {
        ...
        public when_reporting_a_failure_event_with_category_and_sub_category()
        {
