...
{
    public class when_reporting_a_failure_event_with_category_and_no_category_explicitly_specified : Specification
    {
        ...
        public when_reporting_a_failure_event_with_category_and_no_category_explicitly_specified()
        {
