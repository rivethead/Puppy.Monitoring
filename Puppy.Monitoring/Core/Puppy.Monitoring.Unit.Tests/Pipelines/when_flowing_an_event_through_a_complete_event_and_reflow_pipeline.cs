...
{
    public class when_flowing_an_event_through_a_complete_event_and_reflow_pipeline : Specification
    {
        ...
        [Observation]
        public void the_pipelets_following_the_generating_pipelet_receives_original_event_before_the_generated_event()
        {
