...
{
    public class when_flowing_an_event_through_a_reflow_on_event_pipeline : Specification
    {
        ...
        public when_flowing_an_event_through_a_reflow_on_event_pipeline()
        {
            ...
            pipe_line = new ReflowOnEventPipeline(new List<IPipelet>
                {
                    pipelet_1,
                    pipelet_2,
                    pipelet_3,
        ...
        {
            pipelet_4.Events.First().ShouldBeType<AnotherTestEvent>();
            pipelet_4.Events.Last().ShouldBeType<TestEvent>();
        }
    }
}